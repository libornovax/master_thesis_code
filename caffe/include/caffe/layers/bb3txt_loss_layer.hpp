...
#ifndef CAFFE_BB3TXT_LOSS_LAYER_HPP_
#define CAFFE_BB3TXT_LOSS_LAYER_HPP_
...
/**
 * @brief The BB3TXTLossLayer class
 *
...
class BB3TXTLossLayer : public LossLayer<Dtype>, public InternalThreadpool
{
public:

    explicit BB3TXTLossLayer (const LayerParameter &param);
    virtual ~BB3TXTLossLayer ();
...
#endif  // CAFFE_BB3TXT_LOSS_LAYER_HPP_
